...
fee schedules, mark-to-market valuations, distributions, and signed cashflow statements. All data
is synthetic and scoped to a report date of **2026-06-25**.
...
The `pgvector` extension is installed and available for future use — for example, if company
descriptions or investment theses are added as free text, or if a help article knowledge base
